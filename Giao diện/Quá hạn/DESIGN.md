...
The palette is anchored by a breathable light background to ensure a "breathable" interface. 
- **Primary:** A soft, pastel pink (#F5D6DA) used for primary calls-to-action and key brand moments.
- **Secondary:** A deep black (#111111) for high-impact buttons (like social logins) and primary headings.
- **Tertiary:** A light, neutral gray (#F4F4F4) for secondary buttons and container fills.
- **Neutral:** A cool, desaturated slate-taupe (#6D5F5D) used for body text, placeholders, and subtle borders. This shift provides a modern, balanced contrast against the warm pink tones.
...
### Buttons
- **Primary:** Background: Pastel Pink (#F5D6DA), Text: Neutral-Dark. Large padding (12px 24px).
...
- Rounded-md (8px).
- Placeholder text in the neutral slate-taupe tone (#6D5F5D at reduced opacity).
